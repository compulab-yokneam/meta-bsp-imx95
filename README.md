...
## Setup Yocto environment
  * Download NXP and CompuLab source:
    ```
    source <(curl -L https://raw.githubusercontent.com/compulab-yokneam/meta-bsp-imx95/refs/heads/walnascar/tools/run.me)
    ```
...
The current relase supports three SOC revisions: **A0**, **A1** and **B0**.
   ...
   |NOTE|[Default revision is B0](https://github.com/nxp-imx/meta-imx/blob/walnascar/meta-imx-bsp/conf/machine/include/imx-base-extend.inc#L23)|
   | --- | --- |
...
* Set SM configuration:<br>
  ...
  The systen controller configuration can be changed by setting a value to ``IMXBOOT_VARIANT`` variable in the [``conf/local.conf``](https://github.com/compulab-yokneam/meta-bsp-imx95/blob/walnascar/templates/local.conf/local.conf.soc-revision.append#L8):<br>
