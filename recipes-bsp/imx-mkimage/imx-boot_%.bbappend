...
do_deploy:append:compulab-mx95() {
    ...
    install -m 0644 ${WORKDIR}/Makefile    ${DEPLOYDIR}/${BOOT_TOOLS}
    install -m 0644 ${WORKDIR}/howto.md    ${DEPLOYDIR}/${BOOT_TOOLS}
    install -m 0644 ${WORKDIR}/source.me    ${DEPLOYDIR}/${BOOT_TOOLS}
